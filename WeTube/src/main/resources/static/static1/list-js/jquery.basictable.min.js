...
(function(e) {
	e.fn.basictable = function(t) {
		var n = function(t, n) {
				...
				var s = "";
				t.find("thead tr th").length ? s = "thead th" : t.find("tbody tr th").length ? s = "tbody tr th" : t.find("th").length ?
					s = "tr:first th" : s = "tr:first td", e.each(t.find(s), function() {
						var t = e(this),
			...
			r = function(t, n, r) {
				t.children().each(function() {
					...
					if (t.html() !== "" && t.html() !== "&nbsp;" || !!r.showEmptyCells) {
						...
						t.attr("data-th", s), r.contentWrap && !t.children().hasClass("bt-content") && t.wrapInner(
			...
			s = function(t, n) {
				n.forceResponsive ? e(window).width() <= n.breakpoint ? o(t, n) : u(t, n) : t.removeClass("bt").outerWidth() > t.parent()
					.width() ? o(t, n) : u(t, n)
			},
			o = function(e, t) {
		...
		this.each(function() {
			var r = e(this);
			if (r.length === 0 || r.data("basictable")) return r.data("basictable") && (t == "destroy" ? a(r, r.data(
				"basictable")) : t === "start" ? o(r, r.data("basictable")) : t === "stop" ? u(r, r.data("basictable")) : s(
				r, r.data("basictable"))), !1;
			...
			r.data("basictable", l), n(r, r.data("basictable")), l.noResize || (s(r, r.data("basictable")), e(window).bind(
				"resize.basictable",
				function() {
					f(r)
				}))
